...
(function() {
    ...
    function showBackground(bkgData) {
        ...
        let style = {
            backgroundImage: `url(${paella.utils.folders.resources()}/style/${ bkgData.content })`,
    ...
    function showLogos(logos) {
        ...
        for (var i=0; i<logos.length;++i) {
            ...
            if (!logoNode) {
                ...
                logoNode.domElement.setAttribute('src', `${paella.utils.folders.resources()}/style/${logo.content}`);
            }
            else {
        ...
        if (buttons) {
            ...
            buttons.forEach((btn,index) => {
                ...
                let style = {
                    ...
                    position:'absolute',
                    zIndex:btn.layer,
                    backgroundImage: `url(${paella.utils.folders.resources()}/style/${ btn.icon })`,
                    backgroundSize: '100% 100%',
                    display: 'block'
                };
