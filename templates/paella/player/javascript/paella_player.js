...
(function () {
  ...
  function showBackground(bkgData) {
    ...
    var style = {
      backgroundImage: "url(".concat(paella.utils.folders.resources(), "/style/").concat(bkgData.content, ")"),
  ...
  function showLogos(logos) {
    ...
    for (var i = 0; i < logos.length; ++i) {
      ...
      if (!logoNode) {
        ...
        logoNode.domElement.setAttribute('src', "".concat(paella.utils.folders.resources(), "/style/").concat(logo.content));
      } else {
    ...
    if (buttons) {
      ...
      buttons.forEach(function (btn, index) {
        ...
        var style = {
          ...
          position: 'absolute',
          zIndex: btn.layer,
          backgroundImage: "url(".concat(paella.utils.folders.resources(), "/style/").concat(btn.icon, ")"),
          backgroundSize: '100% 100%',
          display: 'block'
        };
