...
$ilDB->query('UPDATE rep_robj_xmh_config SET cfgkey = ' . $ilDB->quote('mh_directory', 'text') . ', cfgvalue = REPLACE(cfgvalue, "/files", "") WHERE cfgkey = ' . $ilDB->quote('mh_files_directory', 'text'));
?>