...
define(['require', 'jquery', 'underscore', 'backbone', 'engage/engage_core'], function(require, $, _, Backbone, Engage) {
    ...
    var SEARCH_ENDPOINT = "/ilias/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/MHData/episode.json";
    var USERTRACKING_ENDPOINT = "/ilias/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/MHData/ilias/226/footprint.json"
    var mediaPackageID = "";  
...
//	          this.urlRoot = this.urlRoot.replace("_mediaPackageID_",mediaPackageID)
          this.update();
        },
        update: function(){
          //request model data            
