...
define(['require', 'jquery', 'underscore', 'backbone', 'engage/engage_core', 'engage/engage_model', 'engage/engage_tab_logic'], function (require, $, _, Backbone, EngageCore, EngageModel, EngageTabLogic) {
  ...
  var initDesktopView = function(){
    ...
    link.attr({
      type : 'text/css',
      rel : 'stylesheet',
      href : '/ilias44/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/templates/theodul/ui/css/bootstrap/css/bootstrap.css'
    });
    $("head").append(link);
    link = $("<link>");
    link.attr({
      type : 'text/css',
      rel : 'stylesheet',
      href : '/ilias44/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/templates/theodul/ui/css/bootstrap/css/bootstrap-responsive.css'
    });
    $("head").append(link);
