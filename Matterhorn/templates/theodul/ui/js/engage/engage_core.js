  ...
  var EngageCore = Backbone.View.extend({
    ...
    initialize : function () {
      ...
      this.dispatcher.on("Core:init", function () {
        ...
        case "desktop":
            cssAttr.href = '/ilias/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/templates/theodul/ui/css/core_desktop_style.css';
            core_template = "/ilias/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/templates/theodul/ui/templates/core_desktop.html";
        ...
        case "mobile":
            ...
            break;
        case "embed":
            cssAttr.href = '/ilias/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/templates/theodul/ui/css/core_embed_style.css';
            core_template = "/ilias/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/templates/theodul/ui/templates/core_embed.html";
  ...
  function loadPlugin(plugin_path, plugin_name) {
    ...
    require([ plugin_path + 'main' ], function (plugin) {
      ...
      if ($.isArray(plugin.styles)) {
        $.each(plugin.styles, function (style_index, style_path) {
          if (style_path !== "") {
            ...
            link.attr({
              type : 'text/css',
              rel : 'stylesheet',
              href : '/ilias/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/templates/theodul/ui/js/engage/' + plugin_path + style_path
            });
            $("head").append(link);
          }
        });
        ...
        if (plugin.styles !== "") {
          ...
          link.attr({
            type : 'text/css',
            rel : 'stylesheet',            
            href : '/ilias/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/templates/theodul/ui/js/engage/' + plugin_path + plugin.styles
          });
          $("head").append(link);
        }
      }
      ...
      if (plugin.template !== "none") {
        // load template async
        $.get('/ilias/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/templates/theodul/ui/js/engage/' + plugin_path + plugin.template, function (template) {
          // empty data object
          var template_data = {};
          ...
          template_data.plugin_path =  '/ilias/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/templates/theodul/ui/js/engage/' + plugin_path;
          ...
          plugin.pluginPath = '/ilias/Customizing/global/plugins/Services/Repository/RepositoryObject/Matterhorn/templates/theodul/ui/js/engage/' + plugin_path;
